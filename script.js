const PRODUCTS = [
  ...
  {id:7,name:"Kashmiri Lal Masala",price:80,type:"powder",icon:"🌶️",image:"Kashmiri-Lal.png",desc:"Beautiful colour and balanced chilli warmth."},
  {id:8,name:"Sambar Masala",price:90,type:"masala",icon:"🥣",image:"Sambar-Masala.png",desc:"South Indian-inspired flavour for comforting sambar."},
  {id:9,name:"Kala Masala",price:100,type:"masala",icon:"🫘",image:"Kala-Masala.png",desc:"Deep, roasted character for traditional dishes."},
  {id:10,name:"Kanda Lasun",price:60,type:"masala",icon:"🧄",image:"Kanda-Lasun-Masala.png",desc:"A punchy Maharashtrian favourite."},
  {id:11,name:"Malvani Masala",price:100,type:"masala",icon:"🌶️",image:"Malvani-Masala.png",desc:"Bold coastal flavour for curries and seafood."},
  {id:12,name:"Lal Tikhat Medium",price:70,type:"powder",icon:"🔥",image:"Lal-Tikhat-Medium.png",desc:"Everyday medium chilli heat for Indian cooking."}
];
