  ...
  const PRODUCTS = [
  {
    ...
    type: "masala",
    icon: "🍛",
    image: "Chole-Masala.png",
    desc: "Aromatic blend for rich, comforting chole."
  },

  {
    ...
    type: "masala",
    icon: "🥘",
    image: "Pav-Bhaji-Masala.png",
    desc: "Bold Mumbai-style flavour for pav bhaji."
  },

  {
    ...
    desc: "Warm, aromatic finishing masala for everyday cooking."
  },

  {
    ...
    desc: "A fragrant blend made for hearty chicken dishes."
  },

  {
    ...
    type: "masala",
    icon: "🐟",
    image: "Fish-Masala.png",
    desc: "Balanced spices for delicious fish preparations."
  },

  {
    ...
    type: "masala",
    icon: "☕",
    image: "Chaha-Masala.png",
    desc: "A warming blend to elevate your daily chai."
  },

  {
    id: 7,
    name: "Sunday Special Masala",
    price: 100,
    type: "masala",
    icon: "🍲",
    image: "sunday-special-chicken.png",
    desc: "Made for special family meals and weekend cooking."
  },

  {
    ...
    type: "powder",
    icon: "🌶️",
    image: "Kashmiri-Lal.png",
    desc: "Beautiful colour and balanced chilli warmth."
  },

  {
    ...
    type: "masala",
    icon: "🥣",
    image: "Sambar-Masala.png",
    desc: "South Indian-inspired flavour for comforting sambar."
  },

  {
    ...
    type: "masala",
    icon: "🫘",
    image: "Kala-Masala.png",
    desc: "Deep, roasted character for traditional dishes."
  },

  {
    ...
    type: "masala",
    icon: "🧄",
    image: "Kanda-Lasun-Masala.png",
    desc: "A punchy Maharashtrian favourite."
  },

  {
    ...
    type: "masala",
    icon: "🌶️",
    image: "Malvani-Masala.png",
    desc: "Bold coastal flavour for curries and seafood."
  },

  {
    id: 13,
    name: "Lal Tikhat Medium",
    price: 70,
    type: "powder",
    icon: "🔥",
    image: "Lal-Tikhat-Medium.png",
    desc: "Everyday medium chilli heat for Indian cooking."
  }
];
...
function renderProducts(){
  ...
  grid.innerHTML = list.length ? list.map(p => `
    <article class="product">
      <div class="product-art"><img src="${p.image}" alt="${p.name}"><span class="fallback-icon">${p.icon}</span></div>
